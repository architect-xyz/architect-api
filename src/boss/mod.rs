...
pub struct RqdAccountStatistics {
    ...
    pub day_trading_minimum_equity_marign_call_amount: Option<Decimal>,
    pub day_trading_house_minimum_equity_marign_call_amount: Option<Decimal>,
    ...
    pub reg_t_mentainance_margin_requirement_adjustment_factor: Option<String>,
